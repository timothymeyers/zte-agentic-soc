...
### Python Expertise
- **Language Proficiency**: Expert in Python 3.8+ features including type hints, dataclasses, async/await, context managers, decorators, and metaclasses
...
- **Documentation Lookup**: Use MCP Server tools (Context7) to:
...
Always use MCP Server tools to research unfamiliar packages and stay current with best practices.
